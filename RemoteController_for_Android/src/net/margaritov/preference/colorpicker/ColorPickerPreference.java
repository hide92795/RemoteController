...
public class ColorPickerPreference extends Preference implements Preference.OnPreferenceClickListener, ColorPickerDialog.OnColorChangedListener {
	...
	private void init(Context context, AttributeSet attrs) {
		TypedArray tArray = context.obtainStyledAttributes(attrs, R.styleable.ColorPickerPreference);
		mDensity = getContext().getResources().getDisplayMetrics().density;
		setOnPreferenceClickListener(this);
		if (attrs != null) {
			mAlphaSliderEnabled = tArray.getBoolean(R.styleable.ColorPickerPreference_alphaSlider, false);
			mHexValueEnabled = tArray.getBoolean(R.styleable.ColorPickerPreference_hexValue, false);
		}
		tArray.recycle();
	}
	...
	private void setPreviewColor() {
		...
		widgetFrameView.setPadding(widgetFrameView.getPaddingLeft(), widgetFrameView.getPaddingTop(), (int) (mDensity * 8),
